...
public final class Functions {
   ...
   *
   * <p>Note: if {@code map} is a {@link com.squareup.haha.guava.collect.BiMap BiMap} (or can be one), you
   * can use {@link com.squareup.haha.guava.collect.Maps#asConverter Maps.asConverter} instead to get a
