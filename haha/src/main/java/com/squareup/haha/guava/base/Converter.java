 ...
 * an example round-trip using {@link com.squareup.haha.guava.primitives.Doubles#stringConverter}:
 *
 * <ol>
 ...
 *     com.squareup.haha.guava.primitives.Ints#stringConverter Ints.stringConverter} or the {@linkplain
 *     #reverse reverse} views of these.
 * <li>Convert between specific preset values using {@link
 *     com.squareup.haha.guava.collect.Maps#asConverter Maps.asConverter}. For example, use this to create
