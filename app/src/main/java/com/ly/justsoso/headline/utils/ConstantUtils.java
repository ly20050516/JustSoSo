package com.ly.justsoso.headline.utils;
...
public class ConstantUtils {
    ...
    public static final String TYPE_VALUE_EDU = "edu";
    public static final String TYPE_VALUE_ENT = "ent";
    public static final String TYPE_VALUE_MONEY = "money";
