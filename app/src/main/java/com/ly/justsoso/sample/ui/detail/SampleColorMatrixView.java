...
public class SampleColorMatrixView extends AbstractDetailView {
    ...
    public SampleColorMatrixView(Context context) {
        super(context);
    }
    ...
    private void applySeekBarChange() {
        Bitmap bitmap = ColorMatrixUtil.colorMatrix(mBitmap,mRotate,mSaturation,mScale);
        if(bitmap != null) {
